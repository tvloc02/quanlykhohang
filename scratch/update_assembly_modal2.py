                      ...
                      <table className="w-full border-collapse text-sm">
                        ...
                        <tbody>
                          {warehouses.length === 0 ? (
                            ...
                            const isDef = distForm.newProductDefaultWarehouse === wh.name || warehouses[0].name === wh.name;
                            if (isDef && !distForm.newProductDefaultWarehouse) {
                                // Default selection will fallback to the first warehouse conceptually
                            }
                            return (
...
print("Modal overwritten completely")
