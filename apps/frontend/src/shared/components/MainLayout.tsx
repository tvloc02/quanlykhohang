                      ...
                      notifications.map((notif) => (
                        <button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              await fetch(
                                `${API_BASE_URL}/notifications/${notif.id || notif._id}/read`,
                                {
                                  method: "POST",
                                  headers: {
                                    Authorization: `Bearer ${localStorage.getItem("token") || ""}`,
            ...
            <div className="relative dropdown-container">
              ...
              >
                ...
                <div className="hidden md:block text-left">
                  ...
                  <p className="text-[11px] sm:text-xs font-medium text-slate-500 dark:text-indigo-300 max-w-[140px] truncate">
                    {userEmail}
                  </p>
                </div>
