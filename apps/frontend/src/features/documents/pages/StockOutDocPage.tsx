  ...
  return (
    <div className="font-sans space-y-4">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        {activeTab === 'TEMPLATE' && (
          <button
            ...
            onClick={() => {
              setNewTemplateForm({
                templateCode: `PXK/00${templates.length + 1}`,
      ...
      {activeTab === 'LIST' ? (
        ...
        /* TAB 2: MẪU PHIẾU XUẤT KHO (DANH SÁCH MẪU CHỨNG TỪ TỰ ĐỘNG) */
        <div className="space-y-4">
          {/* Search Toolbar for Mẫu phiếu xuất kho (Full Width Search) */}
                  ...
                  {filteredTemplates.length === 0 ? (
                    <tr>
                      <td colSpan={9} className="p-8 text-center text-sm font-semibold text-slate-500">
                        Chưa có mẫu phiếu xuất kho nào được tạo.
                      </td>
                    </tr>
                  ) : (
