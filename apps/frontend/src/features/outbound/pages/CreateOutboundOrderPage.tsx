...
export default function CreateOutboundOrderPage({
  ...
  const handleAddTab = () => {
    ...
    const newTab = createNewOutboundTab(newIndex, currentUserName);
  ...
  const handleBarcodeScanned = (scanned: ScannedProduct) => {
    ...
    const priceVal = scanned.purchasePrice || 0;
  ...
  const contentMarkup = (
    <div className="space-y-4 pb-24 animate-[fadeIn_0.2s_ease-out]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                    ...
                    >
                      ...
                      <td className="p-0 text-center border-r border-slate-200">
                        <input
                          ...
                          className="w-full h-8 text-center bg-transparent font-semibold outline-none focus:bg-cyan-100/50 text-xs"
                        />
                      </td>
                      ...
                      <td className="p-0 border-r border-slate-200">
                        <input
                          ...
                          className="w-full h-8 px-2 text-right bg-transparent font-bold text-slate-900 outline-none focus:bg-cyan-100/50 text-xs"
                        />
                      </td>
                      ...
                      <td className="p-0 border-r border-slate-200">
                        <input
                          ...
                          className="w-full h-8 px-2 text-right bg-transparent font-semibold text-slate-800 outline-none focus:bg-cyan-100/50 text-xs"
                        />
                      </td>
                      ...
                      <td className="p-0 border-r border-slate-200">
                        <input
                          ...
                          className="w-full h-8 px-2 text-right bg-transparent font-semibold text-slate-700 outline-none focus:bg-cyan-100/50 text-xs"
                        />
                      </td>
                      ...
                      <td className="p-0 border-r border-slate-200">
                        <input
                          ...
                          placeholder="Ghi chú..."
                          className="w-full h-8 px-2 bg-transparent font-normal text-slate-700 outline-none focus:bg-cyan-100/50 text-xs"
                        />
                      </td>
        ...
        {/* ── RIGHT COLUMN (3/12 width): PAYMENT & FINANCIAL METADATA FORM (Matching Image 2) ── */}
        <div className="lg:col-span-3 rounded-xl border-2 border-slate-200 bg-white p-3.5 shadow-sm space-y-3 h-fit text-xs font-semibold text-slate-800">
          ...
          {/* Sử dụng điểm tích (Matching Image 2) */}
          ...
          {/* Tổng tiền VAT (Matching Image 2) */}
          <div className="flex items-center justify-between text-xs font-semibold text-slate-800 pt-1">
            <span>Tổng tiền VAT:</span>
            <span className="font-bold text-slate-900">{vatAmount.toLocaleString('vi-VN')}</span>
          </div>

          {/* Tổng tiền Input Box (Matching Image 2) */}
          <div className="flex items-center justify-between gap-2 text-xs font-semibold text-slate-800">
            ...
            <input
              ...
              className="h-9 w-full rounded-md border border-slate-300 bg-slate-100 px-3 text-right font-bold text-slate-800 outline-none"
            />
          </div>

          {/* Hình thức thanh toán Radios & Dropdown (Matching Image 2) */}
          ...
          {/* Thanh toán Input Box (Matching Image 2) */}
          <div className="flex items-center justify-between gap-2 text-xs font-semibold text-slate-800 pt-1">
          ...
          {/* ══ Light Theme Payment Summary Box (Matching Image 4 Light Theme Request) ══ */}
          <div className="rounded-xl border-2 border-cyan-200 bg-cyan-50/60 p-4 shadow-sm space-y-2.5 text-slate-800">
            ...
            <div className="flex items-center justify-between text-xs font-semibold text-slate-700">
              ...
              <input
                ...
                placeholder="0"
                className="h-8 w-16 rounded-lg bg-white px-2.5 text-right font-extrabold text-cyan-900 text-xs outline-none border border-slate-300 focus:border-cyan-600 shadow-xs"
              />
            </div>
          ...
          <div className="space-y-2 pt-1">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-xs font-extrabold text-white shadow-md hover:bg-emerald-700 transition active:scale-95 cursor-pointer"
            >
              <Printer size={16} />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-cyan-700 px-4 py-2.5 text-xs font-extrabold text-white shadow-md hover:bg-cyan-800 transition active:scale-95 cursor-pointer"
            >
              <Save size={16} />
