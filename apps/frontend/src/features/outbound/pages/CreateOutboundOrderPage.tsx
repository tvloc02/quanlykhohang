                        ...
                        if (
                          ...
                          if (pctMatch) {
                            ...
                            deductPct = Math.min(
                              ...
                              Math.max(
                                1,
                                Math.round((exportQty / oldQty) * oldPct),
                              ),
                            );
                          } else {
    ...
    >
      ...
      {!isFullScreen && (
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 flex-shrink-0">
          <div className="inline-flex items-center gap-2 rounded-xl bg-cyan-600 dark:bg-indigo-600 px-3 py-1.5 sm:px-4 sm:py-2 text-white shadow-sm w-fit">
            {isDisposal ? (
              <FileX className="h-4 w-4 sm:h-5 sm:w-5 text-cyan-100 dark:text-indigo-200" />
            ) : (
              <ArrowUpFromLine className="h-4 w-4 sm:h-5 sm:w-5 text-cyan-100 dark:text-indigo-200" />
            )}
