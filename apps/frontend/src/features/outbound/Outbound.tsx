    ...
    try {
      ...
      localOrders.forEach((lo) => {
        ...
        if (
          !combinedList.some(
            (co) =>
              (co.orderNo && co.orderNo === loNo) ||
              (co.id && String(co.id) === String(lo.id)),
          )
        ) {
      ...
      if (combinedList.length > 0) {
        ...
        const formatted: OutboundOrder[] = targetList.map(
          (item: any, idx: number) => ({
            ...
            totalQty:
              item.details?.reduce(
                (s: number, d: any) => s + Number(d.requiredQty || d.qty || 1),
                0,
              ) || 1,
            details:
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="relative flex-1 min-w-[320px]">
                ...
                <input
                  ...
                  placeholder={
                    isDisposal
                      ? "Tìm theo mã phiếu hủy, lý do xuất hủy, kho, nhân viên..."
                      : "Tìm theo mã phiếu xuất, khách hàng, SĐT, nhân viên..."
                  }
                />
              </div>
