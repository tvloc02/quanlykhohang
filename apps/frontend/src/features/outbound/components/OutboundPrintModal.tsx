...
export default function OutboundPrintModal({
  ...
  const foundWh = warehouses.find(
    (w) =>
      ...
      w.name === warehouseCode ||
      w.id === warehouseCode,
  );
  const warehouseName = foundWh
    ? `[${foundWh.code}] ${foundWh.name}`
    : warehouseCode || "Kho Thanh Trì";
  const warehouseLocation =
    foundWh?.address || settings.address || "Hà Nội, Việt Nam";
        ...
        >
          ...
          <div className="space-y-1.5 text-xs sm:text-sm text-slate-900 mb-3 border-t border-slate-300 pt-2">
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className="col-span-6 flex">
                ...
                <span
                  className="font-semibold ml-2 text-slate-950 truncate"
            ...
            <div className="grid grid-cols-12 gap-2">
              <div className="col-span-5 flex">
                ...
                <span className="font-bold ml-2 text-slate-950">
                  {nfc(warehouseName)}
                </span>
              </div>
            ...
            <table className="w-full border-collapse border border-slate-900 text-xs sm:text-sm text-slate-900 text-left">
              <thead>
                ...
                <tr className="bg-[#fef9c3] print:bg-[#fef9c3] font-bold text-center text-slate-950 border-b border-slate-900">
                  ...
                  <th className="border border-slate-900 p-2 text-center w-16">
                    Đơn vị tính
                  </th>
                  <th
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 border-t border-slate-900 font-normal mt-1">
                      <span className="border-r border-slate-900 p-1 font-bold">
                        Yêu cầu
                      </span>
                ...
                <tr className="bg-[#fef08a] print:bg-[#fef08a] text-center italic text-xs font-semibold text-slate-800 border-b border-slate-900">
                  <th className="border border-slate-900 p-0.5 text-center">
                    A
                  </th>
                  <th className="border border-slate-900 p-0.5 text-center">
                    B
                  ...
                  <th className="border border-slate-900 p-0.5 text-center w-14">
                    1
                  </th>
                  <th className="border border-slate-900 p-0.5 text-center w-14">
                    2
              ...
              <tbody>
                {details.map((d, i) => {
                  ...
                  return (
                    <tr key={i} className="hover:bg-slate-50 transition">
                      ...
                      <td className="border border-slate-900 p-2 text-center font-mono text-xs">
                        {nfc(d.productSku || "-")}
                      </td>
                ...
                {Array.from({ length: emptyRowsCount }).map((_, emptyIdx) => (
                  <tr
                    key={`empty-${emptyIdx}`}
                    className="h-7 text-transparent"
                  >
          ...
          <div className="space-y-1 text-xs sm:text-sm text-slate-900 mb-4">
            <p>
              ...
              <strong className="italic font-bold text-slate-950">
                {nfc(totalAmountWords)}
              </strong>
            </p>
            <p>
              Số chứng từ gốc kèm theo:{" "}
              <span className="font-semibold">
                01 Hóa đơn GTGT số {order.orderNo?.slice(-7) || "0000025"}{" "}
                {nfc(dateFormattedText)}
              </span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2 text-center text-xs sm:text-sm text-slate-950 page-break-inside-avoid">
            ...
            <div className="flex flex-col justify-between min-h-[120px]">
              <div>
                <p className="font-black uppercase text-[12px] sm:text-xs">
                  Người lập phiếu
                </p>
              ...
              <div className="pt-8">
                <p className="font-bold text-slate-950">
                  {nfc(
                    order.employeeName || settings.creatorName || "Vũ Hữu Dũng",
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between min-h-[120px]">
              ...
              <div className="pt-8">
                <p className="font-bold text-slate-950">
                  {nfc(
                    order.customer || settings.receiverName || "Phạm Thị Duyên",
                  )}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between min-h-[120px]">
              ...
              <div className="pt-8">
                <p className="font-bold text-slate-950">
                  {nfc(settings.storekeeperName || "Nguyễn Thị Thúy")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between min-h-[120px]">
              ...
              <div className="pt-8">
                <p className="font-bold text-slate-950">
                  {nfc(settings.chiefAccountantName || "Trần Thị Hồng Mơ")}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between min-h-[120px]">
              ...
              <div className="pt-8">
                <p className="font-bold text-slate-950">
                  {nfc(settings.directorName || "Nguyễn Thị Thanh Xuyên")}
                </p>
              </div>
            </div>
          </div>
