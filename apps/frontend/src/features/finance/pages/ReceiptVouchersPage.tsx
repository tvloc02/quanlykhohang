    ...
    <div className="space-y-6 pb-12 text-slate-800">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="inline-flex items-center gap-2.5 rounded-2xl bg-cyan-600 px-5 py-2.5 text-white shadow-md">
            ...
            <h1 className="text-xl font-extrabold tracking-tight uppercase">Viết phiếu thu tiền</h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="flex h-[72px] items-center justify-between rounded-xl border-2 border-cyan-500 bg-white px-5 shadow-sm transition hover:bg-cyan-50">
          <div>
            <p className="text-xs font-bold text-slate-500 uppercase">TỔNG SỐ PHIẾU THU</p>
        ...
        <div className="flex h-[72px] items-center justify-between rounded-xl border-2 border-cyan-500 bg-white px-5 shadow-sm transition hover:bg-cyan-50">
          <div>
            <p className="text-xs font-bold text-slate-500 uppercase">TỔNG THU (TOÀN BỘ)</p>
            <p className="text-lg font-black text-emerald-600">{totalAmount.toLocaleString('vi-VN')} đ</p>
          </div>
        ...
        <div className="flex h-[72px] items-center justify-between rounded-xl border-2 border-cyan-500 bg-white px-5 shadow-sm transition hover:bg-cyan-50">
          <div>
            <p className="text-xs font-bold text-slate-500 uppercase">THU TIỀN HÔM NAY</p>
              ...
              {paginatedVouchers.length === 0 ? (
                <tr>
                  <td colSpan={10} className="py-12 text-center text-slate-500 font-semibold">
                    Chưa có phiếu thu tiền nào. Hãy bấm <b>Tạo phiếu thu mới</b> để thêm bản ghi.
                  </td>
                </tr>
              ) : (
