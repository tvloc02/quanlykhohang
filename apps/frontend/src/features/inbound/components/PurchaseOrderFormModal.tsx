          ...
          {options.length === 0 ? (
            ...
            options.map((option) => (
              <button
                ...
                className={`w-full px-4 py-2.5 text-left text-sm font-bold transition hover:bg-slate-50 ${option.value === value ? 'bg-cyan-50 text-cyan-700' : 'text-slate-700'
                  }`}
              >
                {option.label}
              </button>
          ...
          <div className="w-full max-w-xl rounded-3xl bg-white shadow-2xl flex flex-col max-h-[80vh] overflow-hidden border border-slate-100 animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50 to-white">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-base font-black text-slate-900">Tìm kiếm & Chọn hàng hóa</h4>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="p-4 border-b border-slate-100 bg-slate-50/50">
              <div className="relative flex items-center rounded-2xl border-2 border-slate-200 bg-white px-4 h-11 transition-all focus-within:border-cyan-500 focus-within:ring-4 focus-within:ring-cyan-500/10">
                ...
                <input
                  type="text"
                  placeholder="Nhập tên hàng hóa hoặc mã hàng hóa..."
                  value={productSearch}
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2">
              {filteredSupplierProducts.length === 0 ? (
                <div className="text-center py-10 text-slate-400">
                  ...
                  <p className="text-sm font-bold">Không tìm thấy hàng hóa nào</p>
                ...
                filteredSupplierProducts.map((p) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between p-3.5 rounded-2xl border-2 text-left transition cursor-pointer ${isSelected
                    ...
                    >
                      ...
                      <div className={`h-6 w-6 rounded-full border-2 flex items-center justify-center transition ${isSelected ? 'border-cyan-500 bg-cyan-500 text-white' : 'border-slate-300'
                        }`}>
